...
import { LogIn, UserPlus, Info, X, Mail, ArrowLeft, Globe } from 'lucide-react';
                    ...
                    >
                        ...
                        >
                            ...
                            <p style={{ margin: '0.4rem 0 0', fontSize: '0.82rem', color: 'rgba(255,255,255,0.35)' }}>
                                Cronologia versioni &middot; versione attuale:{' '}
                                <strong style={{ color: 'rgba(255,255,255,0.6)' }}>v{__APP_VERSION__}</strong>
                            </p>
                        </div>
                            ...
                            [
                                {
                                    version: '4.6.1',
                                    date: '19/04/2026',
                                    title: 'UI Restore & Code Cleanup',
                                    changes: [
                                        'Ripristino completo dell\'interfaccia utente: label, intestazioni, placeholder e layout riportati alla versione originale.',
                                        'Pulizia codice: rimossi residui del debug precedente (variabili _unusedExport, _unusedLoad, _unusedSetDelete) nel componente Installazioni.',
                                        'Ricollegamento logica: i pulsanti Salva/Elimina puntano correttamente alle nuove funzioni Firebase (installation_data + fogli_condivisi).',
                                        'Validazione form confermata attiva: campi obbligatori, formato date e doppio click su Elimina per conferma.',
                                        'Build TypeScript pulita: zero errori di compilazione dopo la patch.',
                                    ],
                                },
                                {
                                    version: '4.0.3',
                                    date: '05/04/2026',
                                    title: 'Definitive Fix & Versioning Stability',
                                    changes: [
                                        'Risolto definitivamente il problema di visibilità delle installazioni.',
                                        'Implementato sistema di versioning robusto per evitare discrepanze cache/server.',
                                        'Corretti fallback di sicurezza sulla pagina installazioni.',
                                    ],
                                },
                                {
                                    version: '4.0.2',
                                    date: '05/04/2026',
                                    title: 'Checklist Collaudo su Installazioni',
                                    changes: [
                                        'Abilitata la Checklist di Collaudo anche per le macchine in Gestione Installazioni.',
                                        'Aggiunto pulsante rapido per la checklist direttamente nelle card delle installazioni.',
                                        'Pulsante checklist disponibile nel dettaglio dell\'installazione per le macchine da collaudare.',
                                    ],
                                },
                                {
                                    version: '4.0.1',
                                ...
                                },
                                {
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Nuova Sezione Magazzino: Gestione completa di inventario, carichi e scarichi.',
                                        "Pacco Materiali: Possibilità di scaricare ricambi associandoli direttamente a un Ticket o a un'Installazione.",
                                        'Alert Sottoscorta: Invio automatico di email a l.fagetti@dfvautomazioni.it quando un articolo scende sotto la soglia minima.',
                                        "Ottimizzazione Mobile: Interfaccia di scarico rapida pensata per l'uso sul campo da smartphone.",
                                        'Tracciabilità: Ogni movimento (carico/scarico) viene loggato con data, ora e nome del tecnico.',
                                    ],
                                },
                                {
                                    version: '3.4.0',
                                    label: 'AUDIT & CHECKLIST POWER-UP',
                                    color: '#f59e0b',
                                    items: [
                                        'Centralizzazione Versione: Sistema di versionamento ora gestito centralmente da package.json.',
                                        'Pannello Admin: Aggiunte 4 nuove checklist di collaudo configurabili e rinominabili.',
                                        'Nuovo Layout Checklist: Visualizzazione compatta a 2 colonne (50% width) per una migliore gestione su desktop.',
                                        'Audit Codebase: Verifica stabilità e predisposizione per futuri aggiornamenti importanti.',
                                    ],
                                },
                                {
                                    version: '3.3.0',
                                    label: 'SHEETS STABILITY PATCH',
                                    color: '#22c55e',
                                    items: [
                                        "Fix Data Foglio: La data di installazione viene ora inviata al foglio Google nel formato corretto (YYYY-MM-DD) senza l'ora, evitando errori nelle formule e nei filtri del foglio.",
                                        'Fix Calendar→Sheets: Quando si crea un evento su Google Calendar, la data pianificata viene ora aggiornata anche nella colonna H del foglio Google (in precedenza veniva ignorata).',
                                        'Fix Token Scaduto: Il messaggio di errore per il token Google scaduto è ora chiaro e ti guida step-by-step per ripristinare il collegamento.',
                                        'Fix Notifiche Doppie: Le notifiche WhatsApp per le nuove importazioni non vengono più inviate due volte in caso di doppio click su "Ricarica".',
                                        'Nome Tab Foglio Configurabile: Puoi ora specificare nelle Impostazioni il nome esatto del tab del foglio Google (default: ORDINI) — utile se il foglio ha un nome personalizzato.',
                                    ],
                                },
                                {
                                    version: '3.2.0',
                                    label: 'WHATSAPP PRO: IMPORTS & CALENDAR',
                                    color: '#25d366',
                                    items: [
                                        'Notifiche Importazioni: Ricevi un messaggio WhatsApp quando vengono rilevati nuovi ordini nel foglio Google.',
                                        'Notifiche Calendario: Conferma automatica via WhatsApp alla creazione di ogni evento calendario.',
                                        'Admin Control: Nuovi toggle nelle impostazioni per gestire ogni tipo di notifica WhatsApp.',
                                        'Data Safety: Sistema di tracciamento intelligente per evitare notifiche duplicate durante i refresh.',
                                    ],
                                },
                                {
                                    version: '3.1.37',
                                ...
                                {
                                    version: '3.6.0',
                                    label: 'UTF-8 ENCODING BUGFIX',
                                    color: '#10b981',
                                    items: [
                                        'Encoding Fix: Ripristinata la corretta visualizzazione delle emoji (Pacco, Note, Stati) nelle card.',
                                        'Stabilità UI: Sostituite alcune icone di sistema con componenti Lucide per evitare corruzioni future.',
                                    ],
                                },
                                {
                                    version: '3.5.4',
                                    label: 'UI OPTIMIZATION & MODAL RESTYLE',
                                    color: '#10b981',
                                    items: [
                                        'Restyling Scarico: Il modulo ora è centrato e posizionato in alto per una migliore ergonomia.',
                                        'Visibilità Card: Tasto Materiali esteso a tutti i layout delle installazioni (attive e fatturate).',
                                        'UX Migliorata: Solo icona 📦 nei layout compatti per gestire meglio lo spazio.',
                                    ],
                                },
                                {
                                    version: '3.5.3',
                                    label: 'MAGAZZINO & ADMIN OPTIMIZATION',
                                    color: '#10b981',
                                    items: [
                                        'Magazzino: Gestione completa carico/scarico materiali.',
                                        'Alert Sottoscorta: Notifiche email automatiche per giacenze basse.',
                                        'Admin Visibility: Icona materiali ora visibile a tutti gli Admin nelle card.',
                                        'Mobile Fix: Icone più grandi e leggibili per lo scarico rapido in cantiere.',
                                    ],
                                },
                                {
                                    version: '3.1.31',
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        // Renamed 'changes' to 'items' for consistency
                                ...
                                },
                                {
                                    ...
                                    color: '#ef4444',
                                    items: [
                                        'Aggiunta gestione multi-sezione configurabile (es. Assistenza SK vs Installazioni Esterne).',
                                        'Fix doppi tag stato su file Google Sheets.',
                                        'Rimosso prompt infinito di consenso Google.',
                                    ],
                                },
                                {
                                    version: '2.2.37',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Risolto problema Milani 653: stabilizzato ID univoco e corretto parsing date.',
                                        'Rifinito ordinamento gerarchico: Arancione (Top), Blu (Centro), Giallo/Verde (Coda).',
                                    ],
                                },
                                {
                                    version: '2.2.36',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Implementata logica glow multi-colore: Arancione (Pianificate), Giallo (Da collaudare), Verde (Collaudate).',
                                        'Ordinamento prioritario secondo gerarchia cliente.',
                                    ],
                                },
                                {
                                    version: '2.2.35',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        "Fix definitivo lampeggio casuale e ordinamento intelligente basato sull'attualità delle date.",
                                    ],
                                },
                                {
                                    version: '2.2.34',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Risolto problema lampeggio e ordinamento per installazioni in collaudo.',
                                        'Implementata formattazione Calibri 16 automatica sul foglio Google.',
                                    ],
                                },
                                {
                                    version: '2.2.33',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Regolati colori Google Sheets per una maggiore visibilità (Giallo e Verde vivaci).',
                                    ],
                                },
                                {
                                    version: '2.2.32',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Rilevamento intelligente del foglio ORDINI per la colorazione automatica.',
                                    ],
                                },
                                {
                                    version: '2.2.31',
                                    label: 'FIX',
                                    color: '#10b981',
                                    items: ['Ottimizzazione colorazione righe e debug sincronizzazione fogli Google.'],
                                },
                                {
                                    version: '2.2.30',
                                    label: 'FEATURE',
                                    color: '#6366f1',
                                    items: [
                                        'Colorazione automatica righe: il foglio Google diventa Giallo al salvataggio e Verde al collaudo.',
                                    ],
                                },
                                {
                                    version: '2.2.29',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Ricerca potenziata: ora puoi cercare anche per Modello SK e Luogo di Installazione.',
                                        'Risolto problema dei record duplicati nel rendering.',
                                    ],
                                },
                                {
                                    version: '2.2.28',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        "Forzata schermata di consenso Google per garantire l'attivazione dei permessi Sheets.",
                                    ],
                                },
                                {
                                    version: '2.2.27',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        "Risolto slittamento dati: l'app ora identifica le righe in modo intelligente anche se ne vengono aggiunte di nuove nel foglio.",
                                    ],
                                },
                                {
                                    version: '2.2.26',
                                    label: 'FIX',
                                    color: '#10b981',
                                    items: ['Correzione definitiva permessi Google Sheets (scopes).'],
                                },
                                {
                                    version: '2.2.25',
                                    label: 'FIX',
                                    color: '#10b981',
                                    items: [
                                        'Risolto definitivamente errore di autorizzazione per la scrittura sui fogli Google.',
                                    ],
                                },
                                {
                                    version: '2.2.24',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Risolto errore di autorizzazione (insufficient scopes) per la scrittura sui fogli Google.',
                                    ],
                                },
                                {
                                    version: '2.2.23',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Sincronizzazione bidirezionale: salvataggio dati (Data, Matricola, Commenti) direttamente sul foglio Google.',
                                    ],
                                },
                                {
                                    version: '2.2.22',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Importazione note integrali: se la colonna Modello SK inizia con ***, la nota viene importata completamente.',
                                    ],
                                },
                                {
                                    version: '2.2.21',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Pulsante "Accedi con Google" nella pagina iniziale.',
                                        'Login e collegamento Calendario in un unico click.',
                                    ],
                                },
                                {
                                    version: '2.2.20',
                                    ...
                                    color: '#f59e0b',
                                    items: [
                                        'Aggiunta modalità "Lista Compatta a 2 Colonne" per le Installazioni.',
                                        'Allineamento perfetto layout a griglia interno.',
                                    ],
                                },
                                {
                                    version: '2.2.15',
                                    ...
                                    color: '#f59e0b',
                                    items: [
                                        'Changelog accessibile direttamente dal pulsante sotto il form.',
                                        'Rimosso selettore pillola Manuale/Changelog: dedicato ora solo alla cronologia.',
                                    ],
                                },
                                {
                                    version: '2.2.14',
                                    ...
                                    color: '#8b5cf6',
                                    items: [
                                        'Selettore Manuale/Changelog rimpiazzato con pillola Glassmorphism e transizioni fluide.',
                                    ],
                                },
                                {
                                    version: '2.2.13',
                                    ...
                                    color: '#0ea5e9',
                                    items: [
                                        'Manuale utente riscritto: ordinamento installazioni, Google Calendar, moduli SuperAdmin.',
                                    ],
                                },
                                {
                                    version: '2.2.12',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Griglia allineata per "Moduli da attivare": colonne proporzionali, ordine visivo garantito.',
                                    ],
                                },
                                {
                                    version: '2.2.11',
                                    ...
                                    color: '#f59e0b',
                                    items: [
                                        'Checklist moduli flex-wrap compatto.',
                                        'Impostazioni Admin: layout a griglia, larghezza piena.',
                                    ],
                                },
                                {
                                    version: '2.2.10',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Sede di installazione (Cliente \u2014 Città) nella card e nel titolo evento Google Calendar.',
                                    ],
                                },
                                {
                                    version: '2.2.9',
                                    ...
                                    color: '#ec4899',
                                    items: [
                                        'Lista Moduli Attivabili configurabile dal pannello Impostazioni senza toccare codice.',
                                    ],
                                },
                                {
                                    version: '2.2.8',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Ordinamento intelligente: installazioni con data evidenziate e in prima posizione.',
                                        'Nuova checklist interattiva Moduli nel Dettaglio Installazione.',
                                    ],
                                },
                                {
                                    version: '2.2.7',
                                    label: 'FIX',
                                    color: '#10b981',
                                    items: ['Parser CSV riscritto per note multiriga nelle celle Google Sheets.'],
                                },
                                {
                                    version: '2.2.6',
                                    label: 'FIX',
                                    color: '#10b981',
                                    items: ['Componenti Estratti riconosciuti anche con celle vuote nel foglio.'],
                                },
                                {
                                    version: '2.2.5',
                                    label: 'LAYOUT',
                                    color: '#f59e0b',
                                    items: [
                                        'Sezione "Applicazioni" rimossa: più spazio ai Componenti Estratti automatici.',
                                    ],
                                },
                                {
                                    version: '2.2.4',
                                    label: 'FIX',
                                    color: '#10b981',
                                    items: ['Fix GID Google Sheet per sincronizzazione precisa componenti.'],
                                },
                                {
                                    version: '2.2.3',
                                    label: 'FEATURE',
                                    color: '#6366f1',
                                    items: [
                                        'Componenti macchina estratti dai commenti Google Sheet.',
                                        'Script onEdit per aggiornamento real-time.',
                                    ],
                                },
                                {
                                    version: '2.2.2',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Google Calendar: evento collaudo con un click.',
                                        'Luce arancione pulsante su schede in attesa verifica.',
                                    ],
                                },
                                {
                                    version: '2.1.0',
                                    ...
                                    color: '#6366f1',
                                    items: [
                                        'Assegnazione ticket al collega in fase creazione.',
                                        'Pannello permessi granulari per Admin e Utenti.',
                                    ],
                                },
                                {
                                    version: '2.0.8',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Corretto errore credential-already-in-use nella riconnessione Google Calendar.',
                                    ],
                                },
                                {
                                    version: '2.0.7',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Google Calendar esteso a tutti gli Admin.',
                                        'Popup se collaudo senza account Google collegato.',
                                    ],
                                },
                                {
                                    version: '2.0.6',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        '"Sposta" sincronizza automaticamente su Google Calendar.',
                                        'Avviso token scaduto, chiusura modal corretta.',
                                    ],
                                },
                                {
                                    version: '2.0.5',
                                    ...
                                    color: '#f59e0b',
                                    items: [
                                        'Auto-completamento aziende. Svuotamento form. Orario default 08:00 eventi.',
                                    ],
                                },
                                {
                                    version: '2.0.0',
                                    ...
                                    color: '#ef4444',
                                    items: [
                                        'Fatturazione automatica da colonna Consegna.',
                                        'Installazioni fatturate a fondo lista. Firebase migrato.',
                                    ],
                                },
                                {
                                    version: '3.6.0',
                                    ...
                                    color: '#10b981',
                                    items: [
                                        'Remozione totale emoji critiche (encoding fix)',
                                        'Supporto icone vettoriali Lucide',
                                        'Pulsanti Materiali integrati nelle card',
                                        'Fix strutturali interfaccia',
                                    ],
                                },
                                {
                                    version: '1.9.x',
                                    ...
                                    color: '#64748b',
                                    items: [
                                        'Installazioni con Google Sheets, dettagli, stati, fix duplicati, cache-busting, mobile ready.',
                                    ],
                                },
                            ] as { version: string; label: string; color: string; items: string[] }[]
