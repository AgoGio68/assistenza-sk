                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                                <input
                                                    ...
                                                    onChange={() =>
                                                        onTogglePermission(user.uid, !!user.canCreateTickets)
                                                    }
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                                <input
                                                    ...
                                                    onChange={() =>
                                                        onUpdateSections(user.uid, user.sections || ['sk'], 'sk')
                                                    }
                                                />
                                                <span
                                                    style={{
                                            ...
                                            {localSettings.section2Enabled && (
                                                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                                    <input
                                                        ...
                                                        onChange={() =>
                                                            onUpdateSections(user.uid, user.sections || ['sk'], 's2')
                                                        }
                                                    />
                                                    <span
                                                        style={{
                                                            fontSize: '0.8rem',
                                                            color: localSettings.section2Color || 'var(--accent-teal)',
                                                            fontWeight: 600,
                                                        }}
                                                    >
                                            ...
                                            {isSuperadmin && user.role !== 'superadmin' && (
                                                <button
                                                    onClick={() => {
                                                        if (
                                                            window.confirm(
                                                                `Sei sicuro di voler ELIMINARE DEFINITIVAMENTE l'utente ${user.displayName || user.email}?`,
                                                            )
                                                        )
