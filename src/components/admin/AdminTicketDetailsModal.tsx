    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Dettagli Assistenza: {selectedTicket.companyName}
                </h3>
                ...
                <div style={{ display: 'grid', gap: '1rem', marginBottom: '1.5rem' }}>
                    ...
                    <div>
                        ...
                        <div>
                            {getCreatorName(selectedTicket, users)}{' '}
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            ...
                            {selectedTicket.status === 'chiuso' &&
                                (selectedTicket.durationHours !== undefined ||
                                    selectedTicket.durationMinutes !== undefined) && (
                                    <span
                                        style={{
                                            fontSize: '0.8rem',
                                    ...
                                    >
                                        Durata: {selectedTicket.durationHours || 0}h{' '}
                                        {selectedTicket.durationMinutes || 0}m
                                    </span>
                                )}
                        </div>
                    </div>
                    ...
                    {selectedTicket.status === 'chiuso' && selectedTicket.closedAt && (
                        <div>
                            ...
                            <div>
                                {getClosedByName(selectedTicket, users)}{' '}
                                <span style={{ color: 'var(--text-secondary)', fontSize: '0.85rem' }}>
                                    il{' '}
                    ...
                    >
                        ...
                        {selectedTicket.photoUrls && selectedTicket.photoUrls.length > 0 && (
                            <div style={{ display: 'flex', gap: '0.5rem', marginTop: '1rem', flexWrap: 'wrap' }}>
                                <strong style={{ width: '100%', fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                                    FOTO ALLEGATE:
                                </strong>
                    ...
                    {selectedTicket.notes && (
                        ...
                        >
                            <strong style={{ color: 'var(--warning-color)', display: 'block', marginBottom: '0.5rem' }}>
                                Appunti / Note di Chiusura:
                            </strong>
