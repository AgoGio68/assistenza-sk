    ...
    return (
        <div className="glass-panel" style={{ padding: '1.5rem' }}>
            ...
            <form onSubmit={onSaveSettings} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '600px' }}>
                ...
                <h4 style={{ marginBottom: '1rem', color: '#38bdf8' }}>Funzionalità Extra: Caricamento Fotografie</h4>
                ...
                <hr style={{ border: 'none', borderTop: '1px solid var(--border-subtle)', margin: '1rem 0' }} />
                <h4 style={{ marginBottom: '1rem', color: 'var(--danger-color)' }}>Gestione Sicurezza e Permessi Ruoli</h4>
                ...
                <hr style={{ border: 'none', borderTop: '1px solid var(--border-subtle)', margin: '1rem 0' }} />
                <h4 style={{ marginBottom: '1rem', color: 'var(--success-color)' }}>Gestione Installazioni (Google Sheets)</h4>
