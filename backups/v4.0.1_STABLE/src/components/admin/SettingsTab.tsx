                ...
                >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1rem' }}>
                        <input
                            ...
                            onChange={(e) =>
                                setLocalSettings((prev: any) => ({ ...prev, enableInstallations: e.target.checked }))
                            }
                            style={{ width: '20px', height: '20px', cursor: 'pointer' }}
                        />
                        <label
                            htmlFor="enableInstallations"
                            style={{
                                fontSize: '1.1rem',
                                fontWeight: 'bold',
                    ...
                    {localSettings.enableInstallations && (
                        ...
                        >
                            <div>
                                ...
                                >
                                    URL Foglio Google (Eseguibile/CSV)
                                </label>
                                <input
                                    type="url"
                                    ...
                                    onChange={(e) =>
                                        setLocalSettings((prev: any) => ({
                                            ...prev,
                                            installationsSheetUrl: e.target.value,
                                        }))
                                    }
                                    style={{ width: '100%', padding: '0.75rem' }}
                                />
                                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
                                    Assicurati che il foglio sia condiviso con "Chiunque abbia il link può
                                    visualizzare".
                                </p>
                            </div>
                            <div>
                                ...
                                >
                                    Modalità Esportazione Voci Manuali
                                </label>
                                <div
                                    style={{
                                        display: 'flex',
                                ...
                                >
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setLocalSettings((prev: any) => ({
                                                ...prev,
                                                insertInstallationsAtTop: e.target.checked,
                                            }))
                                        }
                                        style={{ width: '18px', height: '18px', cursor: 'pointer' }}
                                    />
                                    <label
                                        htmlFor="insertInstallationsAtTop"
                                        style={{
                                            fontSize: '0.9rem',
                                            cursor: 'pointer',
                                            color: 'var(--text-secondary)',
                                    ...
                                    >
                                        Inserisci le nuove installazioni esportate <strong>in CIMA</strong> (Riga 2)
                                        invece che in fondo.
                                    </label>
                                </div>
                            </div>
                            <div>
                                ...
                                />
                                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
                                    Questo testo verrà mostrato in modo fisso davanti al campo matricola nel dettaglio
                                    installazione.
                                </p>
                            </div>
                            {/* v3.3.0: Nome tab foglio — Fix #4 */}
                            <div>
                                <label
                                    style={{
                                        display: 'block',
                                ...
                                >
                                    Nome Tab Foglio Google (Sezione 1)
                                </label>
                                <input
                                    type="text"
                                    placeholder="ORDINI"
                                    value={localSettings.installationsSheetName || ''}
                                    onChange={(e) =>
                                        setLocalSettings((prev: any) => ({
                                            ...prev,
                                            installationsSheetName: e.target.value,
                                        }))
                                    }
                                    style={{ width: '100%', padding: '0.75rem' }}
                                />
                                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', marginTop: '0.5rem' }}>
                                    Nome esatto del tab (foglio secondario) da usare. Default: <strong>ORDINI</strong> —
                            ...
                            {localSettings.section2InstallationsEnabled && (
                                ...
                                >
                                    <div>
                                        ...
                                        >
                                            URL Foglio Google Installazioni (Opzionale)
                                        </label>
                                        <input
                                            type="url"
                                            placeholder="https://docs.google.com/spreadsheets/d/.../edit"
                                            ...
                                            onChange={(e) =>
                                                setLocalSettings((prev: any) => ({
                                                    ...prev,
                                                    section2InstallationsSheetUrl: e.target.value,
                                                }))
                                            }
                                            style={{ width: '100%', padding: '0.75rem' }}
                                        />
                                        ...
                                        >
                                            Se non inserisci l'URL, le installazioni per questa sezione potranno solo
